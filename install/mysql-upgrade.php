...
*
* @file      ./install/mysql-upgrade.php
*/
...
/**
* Since upgrade is not yet needed, these are just placeholders.
*
* $schema['ALTER_{versioncode}']['query'][''] = "";
* $schema['ALTER_{versioncode}']['explain'][''] = 'Table <strong>' . TABLE_PREFIX . '{tablename}</strong> altered, {didsomething}';
*
* $schema['CREATE_{versioncode}']['query']['{tablename}'] = "";
* $schema['CREATE_{versioncode}']['explain']['{tablename}'] = 'Table <strong>' . TABLE_PREFIX . '{tablename}</strong> created';
*/
